...
namespace SocialNetwork.ConsoleApplication
{
    public class ConsoleWriter
    {
        ...
        public void PrintInstructions()
        {
            ...
            _textWriter.WriteLine("Users submit commands to the application. There are four commands. “posting”, “reading”, etc. are not part of the commands; commands always start with the user’s name.");
